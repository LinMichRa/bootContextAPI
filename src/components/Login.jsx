...
import { Context } from '../context/Context' // Asegúrate de importar el contexto desde la ruta correcta
...
export const Login = () => {
  ...
  //Metodo para validar el campo username: no admite espacios en blanco o mayusculas 
  ...
  // Método que se ejecuta al hacer click en enviar en el formulario
  const saveData = e => {
    e.preventDefault();
